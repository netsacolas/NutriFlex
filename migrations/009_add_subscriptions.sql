...
COMMENT ON COLUMN public.user_subscriptions.current_period_end IS 'Validade da assinatura Premium';
...
-- Funcao para gerar registro gratuito automaticamente
